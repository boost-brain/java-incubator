...
public class SwaggerConfig {
    ...
    private String getDescription() {
        return "Микросервис “login-service” предназначен для управления входом/выходом пользователей в приложение, и валидации существующего подключения по SessionId. \n" +
